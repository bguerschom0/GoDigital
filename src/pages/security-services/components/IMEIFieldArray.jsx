...
export const IMEIFieldArray = ({ control, register, errors }) => {
...
// Also create BlockedNumbersArray for consistency
export const BlockedNumbersArray = ({ control, register, errors }) => {
  const { fields, append, remove } = useFieldArray({
    control,
